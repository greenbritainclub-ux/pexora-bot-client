...
$manifestPath='C:\CanaryLogs\plugin-batch-20260906-v1\launch-v84\osrs-endpoint-manifest-v4.json'
$manifest=Get-Content -LiteralPath $manifestPath -Raw|ConvertFrom-Json
$verified=Get-Content -LiteralPath 'C:\CanaryLogs\plugin-batch-20260906-v1\launch-v84\osrs-network-verification-v4.json' -Raw|ConvertFrom-Json
if((Get-FileHash -LiteralPath $manifestPath -Algorithm SHA256).Hash -ne 'BE71B864F493DE7C69E930015083B175C13AA76F9620455965F02EB18913CF41'){throw 'Reviewed world-list endpoint revision differs'}
