...
try{
 ...
 & 'C:\SandboxGuard\local-batch-load-v70\launch-dt1-v70-net-v84\Test-LocalBatchSessionGateV4.ps1' *> (Join-Path $taskCase ($Run+'-session-fixture.txt'))
 ...
 & powershell.exe -NoProfile -NonInteractive -WindowStyle Hidden -ExecutionPolicy Bypass -File 'C:\SandboxGuard\local-batch-load-v70\launch-dt1-v70-net-v84\Validate-LocalBatchVmV70.ps1' -Run $Run -ExpectedProcessId $ExpectedProcessId -ExpectedStartTicks $ExpectedStartTicks
 ...
 & powershell.exe -NoProfile -NonInteractive -WindowStyle Hidden -ExecutionPolicy Bypass -File 'C:\SandboxGuard\local-batch-load-v70\launch-dt1-v70-net-v84\Validate-LocalBatchVmV70.ps1' -Run $Run -ExpectedProcessId $ExpectedProcessId -ExpectedStartTicks $ExpectedStartTicks -AfterAttachment
