...
$taskNetwork='C:\CanaryLogs\plugin-batch-20260906-v1\launch-v84'
...
if((Get-FileHash -LiteralPath $taskManifest -Algorithm SHA256).Hash -ne 'BE71B864F493DE7C69E930015083B175C13AA76F9620455965F02EB18913CF41'){throw 'Reviewed endpoint pin differs'}
