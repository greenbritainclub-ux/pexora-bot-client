...
$manifestPath='C:\SandboxLocalLogs132\plugin-batch-20260906-v1\launch-v144\osrs-endpoint-manifest-v4.json'
$manifest=Get-Content -LiteralPath $manifestPath -Raw|ConvertFrom-Json
$verified=Get-Content -LiteralPath 'C:\SandboxLocalLogs132\plugin-batch-20260906-v1\launch-v144\osrs-network-verification-v4.json' -Raw|ConvertFrom-Json
if((Get-FileHash -LiteralPath $manifestPath -Algorithm SHA256).Hash -ne '1C721EA64DA352430CF69DAC474AD989A55C149AD859E17DD18AECC2422A8756'){throw 'Reviewed world-list endpoint revision differs'}
