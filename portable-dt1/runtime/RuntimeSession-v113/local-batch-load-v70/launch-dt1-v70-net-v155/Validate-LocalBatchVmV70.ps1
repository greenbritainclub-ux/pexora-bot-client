...
try {
    ...
    . 'C:\SandboxGuard\local-batch-load-v70\launch-dt1-v70-net-v155\LocalBatchSessionGateV4.ps1'
    ...
    $parent=Get-PexoraParentProcessIdV155 $game.Id
    ...
    if((Get-FileHash -LiteralPath $kitPath -Algorithm SHA256).Hash -ne 'DDB0B7B1136EE4F1E6DE57305FD9F3E1A312C6F87DFD02972BCB2AC5FD1A5DA4'){throw 'Runtime kit manifest pin'}
