...
if((Get-FileHash -LiteralPath (Join-Path $case 'local-test-kit-v1\manifest.json') -Algorithm SHA256).Hash -ne 'DDB0B7B1136EE4F1E6DE57305FD9F3E1A312C6F87DFD02972BCB2AC5FD1A5DA4'){throw 'Runtime kit manifest pin'}
