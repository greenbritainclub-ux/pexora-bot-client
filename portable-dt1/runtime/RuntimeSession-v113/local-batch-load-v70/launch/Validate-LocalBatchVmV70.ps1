...
try {
    ...
    . 'C:\CanaryTools\NextPluginsV1\LocalBatchSessionGateV4.ps1'
    ...
    if((Get-FileHash -LiteralPath $harness.Path -Algorithm SHA256).Hash -ne '623E1494CC54B1DF607D759392EA191AD31EE7C7C93898D544A5E8C33773EDD2'){throw 'Reviewed normal harness pin'}
    ...
    $allowed=@{
        ...
        'LocalPluginListAttachV2.dll'='C3474C010B64F0CFE44516734130734900B926FF484768070C6F2970EAF28AEA'
    }
