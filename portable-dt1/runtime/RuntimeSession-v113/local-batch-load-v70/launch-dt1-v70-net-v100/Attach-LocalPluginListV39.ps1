...
$case='C:\CanaryLogs\first-launch-20260906-v1';$work='C:\SandboxGuard\first-game-v1';$report=Join-Path $case ('local-list-attach-'+$Tag+'.json')
...
try{
 ...
 & powershell.exe -NoProfile -NonInteractive -WindowStyle Hidden -ExecutionPolicy Bypass -File 'C:\CanaryTools\FirstLaunchV1\Validate-LocalListVm.ps1' -ReportName ('local-list-live-'+$Tag+'.json') -Dt1ManagerReadiness
