...
if((Get-FileHash -LiteralPath 'C:\PreparedRuntime\mike-manager-ready-v1\runtime-kit.json' -Algorithm SHA256).Hash -ne '972E399DDB7D04A58BD72B1EA2A4F891F4DC7E828DF0639B59DCA516E1E43614'){throw 'Runtime kit manifest pin'}
...
$manifest=Get-Content -LiteralPath 'C:\PreparedRuntime\mike-manager-ready-v1\runtime-kit.json' -Raw|ConvertFrom-Json
