...
$taskOut='C:\SandboxLocalLogs132\plugin-batch-20260906-v1\display-preflight-v9-'+[DateTime]::UtcNow.ToString('yyyyMMdd-HHmmss-fff')+'.json'
...
try {
 ...
 $taskInfo.Arguments='-Xmx96m '+$(if($NegativeFixture){'-Djava.awt.headless=true '}else{''})+'C:\SandboxLocalTools132\NextPluginsV1\DisplayPreflightV9.java'
