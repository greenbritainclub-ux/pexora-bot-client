...
try{
 ...
 & powershell.exe -NoProfile -NonInteractive -WindowStyle Hidden -ExecutionPolicy Bypass -File 'C:\CanaryTools\FirstLaunchV1\Validate-LocalListVm.ps1' -ReportName ('local-list-live-'+$Tag+'.json')
