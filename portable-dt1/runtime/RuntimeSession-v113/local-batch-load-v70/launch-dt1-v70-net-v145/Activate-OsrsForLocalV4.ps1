...
$manifestPath='C:\SandboxLocalLogs132\plugin-batch-20260906-v1\launch-v145\osrs-endpoint-manifest-v4.json'
$manifest=Get-Content -LiteralPath $manifestPath -Raw|ConvertFrom-Json
$verified=Get-Content -LiteralPath 'C:\SandboxLocalLogs132\plugin-batch-20260906-v1\launch-v145\osrs-network-verification-v4.json' -Raw|ConvertFrom-Json
