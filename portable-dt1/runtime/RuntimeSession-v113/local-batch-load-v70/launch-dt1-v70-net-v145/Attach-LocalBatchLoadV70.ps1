...
$taskCase='C:\SandboxLocalLogs132\plugin-batch-20260906-v1';$taskWork='C:\SandboxGuard\local-batch-load-v70'
...
$taskPins=@{
 'LocalBatchLoadV70.jar'='C83B5CB655A6BCEBB6F84DEFFD7A7948E0CC6B6688B41BE0D2817A449F7D4625'
...
try{
 ...
 & 'C:\SandboxGuard\local-batch-load-v70\launch-dt1-v70-net-v145\Test-LocalBatchSessionGateV4.ps1' *> (Join-Path $taskCase ($Run+'-session-fixture.txt'))
 ...
 & powershell.exe -NoProfile -NonInteractive -WindowStyle Hidden -ExecutionPolicy Bypass -File 'C:\SandboxGuard\local-batch-load-v70\launch-dt1-v70-net-v145\Validate-LocalBatchVmV70.ps1' -Run $Run -ExpectedProcessId $ExpectedProcessId -ExpectedStartTicks $ExpectedStartTicks
 ...
 & powershell.exe -NoProfile -NonInteractive -WindowStyle Hidden -ExecutionPolicy Bypass -File 'C:\SandboxGuard\local-batch-load-v70\launch-dt1-v70-net-v145\Validate-LocalBatchVmV70.ps1' -Run $Run -ExpectedProcessId $ExpectedProcessId -ExpectedStartTicks $ExpectedStartTicks -AfterAttachment
