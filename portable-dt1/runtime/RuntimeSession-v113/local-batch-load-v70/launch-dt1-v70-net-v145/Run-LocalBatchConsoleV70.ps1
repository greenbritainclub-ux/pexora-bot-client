...
. 'C:\SandboxLocalTools132\FirstLaunchV1\PluginListLaunchGate.ps1'
...
try{
    ...
    & 'C:\SandboxGuard\local-batch-load-v70\launch-dt1-v70-net-v145\Activate-OsrsForLocalV4.ps1' -Run $Run
