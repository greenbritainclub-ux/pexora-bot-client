...
$taskNetwork='C:\SandboxLocalLogs132\plugin-batch-20260906-v1\launch-v146'
...
if((Get-FileHash -LiteralPath $taskManifest -Algorithm SHA256).Hash -ne '588616DAF7143302DD0050B23F641237EB2809E461C388DDFE1CA3248E8F7FB5'){throw 'Reviewed endpoint pin differs'}
...
if([DateTime]::UtcNow.AddMinutes(10) -ge [DateTime]::Parse($taskEndpoints.ExpiresUtc)){throw 'Fresh OSRS endpoint policy required'}
